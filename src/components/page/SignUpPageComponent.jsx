  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-300">
      <div className="flex flex-col bg-white shadow-md px-4 sm:px-6 md:px-8 lg:px-10 py-8 rounded-3xl w-full max-w-md">
        <div className="font-medium self-center text-xl sm:text-2xl text-gray-800">Sign Up To Your Account</div>
        <div className="mt-10">
          <form onSubmit={handleSubmit}>
            ...
            <div className="flex w-full">
              <button type="submit" disabled={isLoading} className="flex items-center justify-center focus:outline-none text-white text-sm sm:text-base bg-green-600 hover:bg-green-700 rounded py-2 w-full transition duration-150 ease-in">
                <span className="font-bold text-xl">{isLoading ? "Sign Up..." : "Sign Up"}</span>
              </button>
            </div>
          </form>
        </div>
        <div className="flex justify-center items-center mt-6">
          <div className="inline-flex items-center font-bold text-gray-700 text-xs text-center">
            ...
            <Link href="/auth">
              <button className="bg-gray-600 hover:bg-gray-700 px-3 py-2 text-white rounded-xl hover:scale-105">Login</button>
            </Link>
          </div>
        </div>
      </div>
